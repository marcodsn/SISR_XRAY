## This script generates the SR images used for evaluation of the eagle enhancement diffusion model.
import os
...
# Paths
WEIGHTS_PATH = "results/training/eagle/model_latest.pth"
INPUT_DIR = "data/LR/"
OUTPUT_DIR = "data/SR/eagle/"
